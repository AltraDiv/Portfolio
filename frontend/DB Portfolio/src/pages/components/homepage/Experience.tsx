...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    cards: [
      { title: 'AI Voice Agents', detail: 'Built healthcare AI agents (Ultravox, LiveKit, Rime TTS) handling 2,200+ monthly calls across 52+ dental clinics' },
      { title: 'LLM Infrastructure', detail: '40% latency drop via multi-provider load balancing with RAG pipelines; 60% cost cut by migrating to open-source models (DeepSeek GLM)' },
      ...
      { title: 'Event-Driven Architecture', detail: 'Redis caching (3x faster reads) and Kafka event streaming; Playwright E2E testing cutting production bugs by 50%' },
    ],
